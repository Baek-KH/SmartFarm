...
//				line_status = line_status + "D_H ";
//			}
//			;
//			if (status_temp < line_temp - 2) {
//				line_status = line_status + "D_L ";
//			}
//			;
...
//	@Scheduled(fixedRate = 6000)	// 테스트용 1분에 한번씩	
...
//			System.out.println("tray_growth = "+tray_growth);
//			vo.setTray_growth(String.format("%.2f", tray_growth));
//			System.out.println(vo.getTray_growth());
