														...
														<td>
															<form action="updateLineDetail.do">
																<input type="hidden" name="line_id"
																	value="${LineVO.getLine_id()}"> <input
																	type="hidden" name="field" value="line_temp"> <input
																	type="text" name="query" placeholder="목표'온도'을 입력해주세요"><input
																	type="submit">
															</form>
														</td>
														<td>
															<form action="updateLineDetail.do">
																<input type="hidden" name="line_id"
																	value="${LineVO.getLine_id()}"> <input
																	type="hidden" name="field" value="line_hum"> <input
																	type="text" name="query" placeholder="목표'습도'을 입력해주세요"><input
																	type="submit">
															</form>
														</td>
														<td>
															<form action="updateLineDetail.do">
																<input type="hidden" name="line_id"
																	value="${LineVO.getLine_id()}"> <input
																	type="hidden" name="field" value="line_pip"> <select
																	name="query">
																	<c:forEach items="${PipList}" var="pipVO">
																		<option value="${pipVO.getPip_name()}">${pipVO.getPip_name()}</option>
																	</c:forEach>
