                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="updateOrders.do" method="post">
                                ...
                                <a href="deleteOrders.do?orders_id=${ordersVO.getOrders_id()}" style="float:right; background-color:rgba(46,139,87); color:white; margin-left: 20px" class="btn" type="submit" value="삭제">삭제</a>
