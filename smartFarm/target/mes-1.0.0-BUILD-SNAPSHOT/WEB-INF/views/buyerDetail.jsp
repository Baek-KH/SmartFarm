                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="updateBuyer.do" method="post" >
	                                <table class="table table-bordered" id="dataTable4" width="100%" cellspacing="0">
	                                    <thead>
	                                        <tr>
	                                            <th>구매처 아이디</th>
	                                            <td>
	                                                <input class="col" name="buyer_id" type="text" value="${buyerVO.getBuyer_id()}" disabled="disabled">
	                                            </td>
	                                        </tr>
	                                        <tr>
	                                            <th>구매처 업체명</th>
	                                            <td><input class="col" type="text" value="${buyerVO.getBuyer_name()}"></td>
	                                        </tr>    
	                                            <th>이메일</th>
	                                            <td><input class="col" type="text" value="${buyerVO.getBuyer_email()}"></td>
	                                        <tr>
	                                            <th>연락처</th>
	                                            <td><input class="col" type="text" value="${buyerVO.getBuyer_number()}"></td>
	                                        </tr>
	                                        <tr>    
	                                            <th>물품명</th>
	                                            <td><input class="col" type="text" value="${buyerVO.getBuyer_product()}"></td>
	                                ...
	                                <input type="hidden" name="buyer_id" value="${buyerVO.getBuyer_id()}">
	                                <a href="deleteBuyer.do?buyer_id=${buyerVO.getBuyer_id()}" style="float:right; background-color:rgba(46,139,87); color:white; margin-left: 20px" class="btn" >삭제</a>
